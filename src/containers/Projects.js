...
export default function Projects() {
  ...
  return (
    ...
    >
      <Modal.Header>
        <Modal.Title id="contained-modal-title-vcenter">Projects <br/><br/>(Please note that live apps are deployed on Heroku and there may be a short wait when loading them)</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Row>
