    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                <p className="modal-text">
                Anyways, here are some links to my socials and then enough about me, let's talk about MY DOGS.
                </p>
                <Row className="justify-content-center">
                    ...
                    <Button variant="outline-dark" style={{margin:20}}href="https://github.com/sean-slaughter">My Network:<br/><FaLinkedin size={50}/></Button>
                </Row>
